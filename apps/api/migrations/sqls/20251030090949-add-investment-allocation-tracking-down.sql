-- =========================================================
-- ROLLBACK: Remove investment allocation tracking
-- =========================================================

-- Drop the materialized view with investment allocation tracking
...
-- =========================================================
-- RECREATE ORIGINAL MATERIALIZED VIEW (without used_investment_allocation)
-- =========================================================
...
SELECT 
    ...
    COALESCE(used_allocation.used_amount, 0) as used_savings_allocation
...
LEFT JOIN (
    ...
    GROUP BY user_id
) used_allocation ON u.id = used_allocation.user_id
