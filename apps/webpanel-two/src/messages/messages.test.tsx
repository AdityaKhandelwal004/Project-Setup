// messages.test.ts
import { parseMessages, getMessages, getLanguages, checkMessages } from '../messages/messages';
...
describe('checkMessages', () => {
  it('warns if a message is missing in any language', () => {
    ...
    expect(consoleWarnSpy).toHaveBeenCalledWith(expect.stringContaining('does not have message'));
